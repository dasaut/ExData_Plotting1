#----------------------------------------------------------------------------
# This is the R code for making the plot #1 belonging to the course project in Coursera "Exploratory Data Analysis"
#
...
#
#plotting a histogram on screen
hist(exdata2007Feb$Global_active_power, xlab='Global Active Power (kilowatts)', col='red', main='Global Active Power')
#
# printing the histogram to a PNG file
